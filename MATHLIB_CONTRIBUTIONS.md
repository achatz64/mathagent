This file is for the mathlib contributor agent.
...
# Deliverables
The deliverables live in the `upstream` folder, as in `upstream/<candidate>/`, with `<candidate>` is an arbitrary folder name. This folder contains:
