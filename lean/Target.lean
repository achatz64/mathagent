...
/-!
AUDIT-GAP (coverage/semantic audit): the unlabeled mathematical prose following the proof of
...
/-!
AUDIT-GAP (coverage/semantic audit): the unlabeled mathematical claim following the proof of
