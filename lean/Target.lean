...
-- AUDIT-GAP (documentation audit, residual from 2026-08-20 verification re-scan): docstring lacks either a proof-idea note or an explicit triviality declaration; state the proof idea or declare the proof trivial.
